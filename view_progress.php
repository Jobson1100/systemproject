...
<body>
	...
	<div class='row'>
		...
		<div class='col-12'>
            ...
            <ul>
                    ...
                    <li class="active"><a href="view_progress.php" ><i class='bx bxs-home'></i>VIEW PROGRESS</a></li>
	...
	<form action="progress.php" method="POST">
        ...
        <?php endif ?>
        <button id="btn-progress" type="submit" name="submit"></a>Update Progress</button>
        <button id="btn-progress-back"><a href="tasks.php"></a>Back</button>
        <br>
    </form>
